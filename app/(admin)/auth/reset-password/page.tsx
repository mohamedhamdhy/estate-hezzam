...
export default function ResetPassword() {
  ...
  const confirmRing = confirmTouched
    ? confirmErr
      ? 'error-ring'
          ...
          <div style={{ padding: '32px 32px 28px' }}>
            ...
            {status === 'success' ? (
              <div style={{ textAlign: 'center', padding: '8px 0 8px' }}>
                ...
                >
                  Your password has been changed and all sessions have been
                ...
                >
                  ...
                  >
                    <span
                      className="f-sans"
                      style={{ fontSize: 9, fontWeight: 700, color: '#D4AF37' }}
                    >
                      {countdown}
                    </span>
                  </span>
                  ...
                  <div style={{ position: 'relative' }}>
                    <span
                      style={{
                        ...
                        transform: 'translateY(-50%)',
                        color:
                          confirmTouched && !confirmErr ? '#34D399' : '#475569',
                        pointerEvents: 'none',
                      }}
                    >
                      <svg
                    ...
                    >
                      {reqs.map(({ label, met }) => (
                        <div
                          ...
                          className="req-item"
                          style={{
                            color: met ? '#34D399' : 'rgba(255,255,255,0.28)',
                          }}
                        >
                          <ReqDot met={met} />
                          <span className="f-sans" style={{ fontSize: 10 }}>
                            {label}
                          </span>
                        </div>
                      ))}
