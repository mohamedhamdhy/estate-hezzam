...
const REVIEWS: Review[] = [
  {
    name: 'Mohammed Al Hamdhy',
    title: 'CEO, HMD',
    location: 'Dubai, UAE',
    rating: 5,
    text: 'Hesham helped us find not just any property but the right investment. Our Dubai Union apartment increased in value by 24 percent within 18 months. His discretion and market knowledge are truly exceptional in this industry.',
    deal: 'Dubai Union Apartment · AED 0.5M',
    dealColor: '#D4AF37',
    initials: 'MR',
    avatarColor: '#D4AF37',
  },
  {
    ...
    location: 'Dubai, UAE',
    rating: 5,
    text: 'Being in Dubai, I was looking for the right property and Hesham handled every step with complete professionalism from property tours to final documentation. The entire process took 18 days which was truly remarkable.',
    deal: 'Deira Apartment · AED 0.2M',
    dealColor: '#60A5FA',
    initials: 'SC',
    avatarColor: '#60A5FA',
  },
  {
    name: 'Mohamed Hasim',
    title: 'Lawyer, Whitmore Capital',
    location: 'Dubai, UAE',
    rating: 5,
    text: 'Living in Dubai, we wanted a smart investment. Hesham delivered beyond our expectations, securing an off-market deal that saved us more than AED 0.4M. Highly recommended.',
    deal: 'Deira Apartment · AED 0.4M',
    dealColor: '#34D399',
    initials: 'JW',
    avatarColor: '#34D399',
  },
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            background: `${r.dealColor}12`,
            color: r.dealColor,
            border: `1px solid ${r.dealColor}28`,
            borderRadius: 100,
            padding: '4px 12px',
          }}
        >
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <span
              className="f-display"
              style={{ fontSize: 16, fontWeight: 700, color: r.avatarColor }}
            >
              {r.initials}
            </span>
          </div>
          ...
          {REVIEWS.map((_, i) => (
            <button
              ...
              style={{
                ...
                cursor: 'pointer',
                background:
                  i === current ? '#D4AF37' : 'rgba(255,255,255,0.15)',
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 py-20 lg:py-28">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 mb-14">
            <div>
              ...
              >
                Delivering high-value deals, above-market returns, and lasting
                client relationships across Dubai’s most prestigious addresses.
              </p>
            </div>
