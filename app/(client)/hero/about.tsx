        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 py-20 lg:py-28">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 mb-16">
            <div>
              ...
              >
                I help discerning clients discover Dubai’s finest luxury
                properties, offering expertise, discretion, and a truly
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.15fr] gap-12 xl:gap-20 items-start mb-16">
              ...
              <div className="relative w-full max-w-[400px]">
                <div
                  ...
                  style={{
                    inset: -2,
                    background:
                      'linear-gradient(135deg, rgba(212,175,55,0.22) 0%, rgba(26,110,142,0.12) 100%)',
                    filter: 'blur(1px)',
                    zIndex: 1,
                  }}
                />
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      inset: 0,
                      background:
                        'linear-gradient(to top, rgba(12,12,15,0.75) 0%, transparent 55%)',
                    }}
                  />
                  <div
                    style={{
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p
                        className="f-sans"
                        style={{ fontSize: 9, color: 'rgba(255,255,255,0.32)' }}
                      >
                        Dubai Marina
                      </p>
                    </div>
            ...
            <div className="flex flex-col gap-8">
              ...
              >
                ...
                >
                  A Dubai-based luxury real estate consultant with a proven
                  track record across the UAE’s most prestigious addresses. From
                  off-plan investments on Palm Jumeirah to ultra-prime Downtown
                  penthouses, every transaction is handled with the care and
                  attention your investment deserves.
                </p>
                <p
                  className="f-sans"
                  style={{
                ...
                >
                  My approach is simple: understand what matters most to you and
                  deliver it with complete transparency, zero pressure, and a
                  network that opens doors most agents cannot reach.
                </p>
              </div>
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
                  ...
                  />
                  <SocialLink
                    href="https://www.tiktok.com/@askar__hesham"
                    label="TikTok"
                    icon={
                      <svg
                        width="14"
    ...
    />
          ...
          >
            ...
            <div className="flex items-center gap-2 shrink-0">
              ...
              >
                Open to new clients · Dubai &amp; worldwide
              </span>
            </div>
          </div>
        </div>
